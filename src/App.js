        ...
        <div className="columns is-vcentered mhx">
          ...
          <div className="columns is-multiline mhx">
            {this.state.contents.map((element,index) => (
              <List key={index} index={index} title={element.title} elements={element.elements} addsElement={this.addsElement} />
            ))}
          </div>
    ...
    return (
      <div className="column is-4">
        <div className="card pam">
          ...
          <AddsElement parentIndex={this.props.index} addsElement={this.props.addsElement} />
        </div>
      </div>
    );
  }
    ...
    return (
      ...
      <div className="field has-addons">
        <div className="control is-expanded">
          <input className="input" onChange={this.handleChange} type="text" placeholder="Add an element" />
        </div>
        <div className="control ">
